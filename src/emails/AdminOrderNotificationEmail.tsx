                ...
                <Container style={container} className="main-container">
                  <Section style={box} className="content-box">
                    ...
                    <Text style={paragraph} className="text-left">
                      A new order has been placed by {order.customerName}. You
                      can view the full order details in the admin dashboard.
                    </Text>
                    ...
                    <Section style={card} className="card">
                      ...
                      <Row style={itemRow}>
                        ...
                        <Column
                          style={{ ...itemValue, textTransform: "capitalize" }}
                          align="right"
                        >
                    ...
                    <Section style={{ textAlign: "center", marginTop: "30px" }}>
                      <Button
                        style={button}
                        href={`${baseUrl}/exec/admin/orders/${order.id}`}
                      >
