                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                {order.phoneNumber ? (
                                    <a href={`tel:${order.phoneNumber}`} className="font-semibold hover:underline block">
                                        {order.phoneNumber}
                                    </a>
                                ) : (
                  ...
                  >
                   ...
                   {order.deliveryMethod === 'collection' && (
                     <Button
                      ...
                      className="w-full justify-start bg-purple-500/20 border-purple-500 text-purple-600 hover:bg-purple-500/30 dark:text-purple-400"
