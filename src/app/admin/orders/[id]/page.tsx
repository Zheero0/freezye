...
import { ArrowLeft, Loader2, Truck, ClipboardCheck } from 'lucide-react';
                                    ...
                                    {order.items.map(item => (
                                        <TableRow key={item.id}>
                                            <TableCell className="hidden md:table-cell">
                                                <Image src={item.imageUrl} alt={item.name} width={64} height={64} className="rounded-md object-cover aspect-square" data-ai-hint={item.imageHint} />
                                            </TableCell>
                                            <TableCell>
