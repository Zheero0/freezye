  ...
  const testimonials = [
    {
      ...
      rating: 5,
      review:
        "Absolutely mind-blowing! The Cosmic Crunchies have a texture and flavour that is out of this world. My kids are obsessed!",
    },
    {
      name: "Tom H.",
      rating: 5,
      review:
        "The express delivery was super fast, and the sweets were even better than I imagined. You've got a customer for life!",
    },
    {
      name: "Emily R.",
      rating: 5,
      review:
        "I bought a selection for a party and they were a massive hit. The Asteroid Bites are dangerously addictive. 10/10!",
    },
  ];
      ...
      <section className="relative w-full bg-accent text-accent-foreground pt-20 md:pt-28 pb-24 md:pb-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Find out why everyone's obsessed! Experience the viral craze with
              an explosive crunch and incredibly intense flavours.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            >
              <div className="flex-shrink-0 bg-primary/20 text-primary rounded-full h-16 w-16 flex items-center justify-center font-bold text-2xl">
                1
              </div>
              <div>
                <h3 className="text-xl font-bold mb-2">We Pick Your Faves</h3>
                <p className="text-muted-foreground">
                  We start with the classic, well-loved sweets you already know
                  and adore.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Our state-of-the-art process removes moisture, making them
                  light and airy.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  The result? A mind-blowing crunchy treat with a
                  super-concentrated taste.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <p className="max-w-2xl mx-auto text-lg text-accent-foreground/90 sm:text-xl mb-8">
            Your taste buds will thank you. Explore our full collection and find
            your new favourite snack today.
          </p>
          <Button
            asChild
            size="lg"
