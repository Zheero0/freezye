  ...
  const onSubmit = async (data: CheckoutFormValues) => {
    if (!stripe || !elements || !clientSecret) {
      toast({
        title: "Error",
        description:
          "Payment services are not ready. Please wait a moment and try again.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (error) {
      ...
      toast({
        title: "Order Placed!",
        description:
          "Thank you for your purchase. Your cosmic treats are on their way!",
      });
  ...
  const getButtonContent = () => {
    switch (processingState) {
      ...
      case "finalizing_order":
        return (
          <>
            <CheckCircle className="mr-2 h-4 w-4" /> Finalizing Order...
          </>
        );
      case "idle":
      default:
      ...
      <div className="flex items-center justify-center py-20">
        <Card className="max-w-md w-full text-center">
          <CardHeader>
            ...
            <CardDescription>
              Looks like you haven't added any cosmic treats yet.
            </CardDescription>
          </CardHeader>
          <CardContent>
